...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/ttclockbot#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ttclockbot
```

A live public deployment of this template is available at [https://ttclockbot.templates.workers.dev](https://ttclockbot.templates.workers.dev)
